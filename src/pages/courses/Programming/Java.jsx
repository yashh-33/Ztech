...
const modules = [
  {
    title: "Module 1 – Java Basics & Programming Core",
    topics: [
      "Variables, Datatypes & Operators",
      "Loops & Functions",
      "Arrays, Strings & OOP Basics",
      "Java Hands-on Mini Projects",
    ],
  },
  {
    title: "Module 2 – Advanced OOP & Enterprise Concepts",
    topics: [
      "Inheritance, Polymorphism, Abstraction & Encapsulation",
      "Static, Final, Interfaces & Packages",
      "Exception Handling & Debugging",
      "File Handling (I/O Streams)",
    ],
  },
  {
    title: "Module 3 – Database & APIs",
    topics: [
      "JDBC with MySQL",
      "SQL CRUD Operations",
      "JSON Data Handling",
      "Project – Java CRUD App with DB",
    ],
  },
  {
    title: "Module 4 – Java for Development",
    topics: [
      "Java Collections Framework",
      "Multi-Threading & Performance",
      "Servlets / JSP (Web Basics)",
      "Spring Boot Introduction",
    ],
  },
  {
    title: "Module 5 – Job & Career Prep",
    topics: [
      "Portfolio Projects",
      "GitHub + Resume + LinkedIn Setup",
      "Mock Interviews & HR Preparation",
      "Career Roadmap & Freelancing Guide",
    ],
  },
];
    ...
    <div className="w-full text-gray-900">
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-28 md:py-32 grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <h1 className="text-[2.8rem] md:text-[3.6rem] font-extrabold text-white leading-tight mb-3">
              Java <span className="text-orange-400">Development</span>
            </h1>

            <div className="h-[3px] w-24 bg-white rounded mb-6" />

            <p className="text-lg text-white/90 max-w-xl">
              Learn Java from basics to real-world development — build strong OOP
              concepts, database apps, web apps & Spring-based projects.
            </p>

            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-10">
              {["1000+ Students", "12 Weeks Program", "5+ Real Projects", "Job-Ready Training"].map(
                (item, i) => (
                  <div
                    key={i}
      ...
      <section className="bg-gradient-to-b from-white to-orange-50 py-24">
        <div className="max-w-6x1 mx-auto px-6">
          <h2 className="text-[2.6rem] font-extrabold text-center mb-6 leading-tight">
            Why Learn Java Programming at <span className="text-orange-500">ZTECHware?</span>
          </h2>
          <p className="text-gray-600 text-center max-w-3xl mx-auto mb-16 text-lg">
            Learn Java from industry-level mentors with a structured roadmap designed
            for placements, backend development & real-world applications.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                title: "Industry-Level Java Curriculum",
                desc: "Curriculum designed with input from experienced Java developers & enterprise-level tech companies.",
                icon: "☕",
              },
              {
                title: "Project-First Java Learning",
                desc: "Build 5+ real-world Java projects including backend systems to showcase in internships & placements.",
                icon: "🚀",
              },
              {
                title: "Career & Placement Support",
                desc: "Resume building, LinkedIn optimization, mock interviews & direct hiring partner referrals for Java developer roles.",
                icon: "💼",
              },
            ].map((card, i) => (
              <div
      ...
      <section className="py-24 bg-gradient-to-b from-white to-gray-50">
        ...
        <p className="text-gray-600 text-center max-w-2xl mx-auto mb-16 text-lg">
          Hands-on Java development environment used by professional software engineers.
        </p>
          ...
          {[
            {
              ...
              icon: "⭐",
              items: ["VS Code", "IntelliJ IDEA", "Jupyter Notebook", "Eclipse IDE"],
            },
            {
              title: "Libraries",
              color: "from-green-600 to-green-500",
              icon: "📚",
              items: ["Core Java APIs", "Spring", "Hibernate", "JUnit"],
            },
            {
              title: "Platforms",
      ...
      <section className="py-24 bg-gradient-to-b from-white to-orange-50">
        <h2 className="text-4xl font-extrabold text-center mb-14">
          Career Paths After Learning <span className="text-orange-500">JAVA</span>
        </h2>
          ...
          {[
            {
              icon: "☕",
              role: "Java Developer",
              desc: "Build robust backend applications, enterprise systems & REST APIs using Java.",

            },
            {
              icon: "🌐",
              role: "Backend Web Developer",
              desc: "Develop scalable web backends using Spring Boot, Hibernate & databases.",
            },
            {
              icon: "🏦",
              role: "Enterprise Application Developer",
              desc: "Work on large-scale enterprise applications used in banking & corporate systems.",

            },
            {
              icon: "📱",
              role: "Android App Developer (Java)",
              desc: "Build Android applications using Java, Android SDK & APIs.",

            },
            {
              icon: "⚙️",
              role: "Software Engineer (Core Java + DSA)",
              desc: "Crack coding interviews with strong Java fundamentals & DSA skills.",
            },
            {
              icon: "🚀",
              role: "Intern / Trainee Java Developer",
              desc: "Apply for Java-based fresher roles, internships & startup jobs.",
            },
          ].map((card, i) => (
            <div
              key={i}
        ...
        <p className="text-center mt-14 text-gray-700 text-lg font-medium">
          🚀 Ideal career opportunities for freshers with strong Java + DSA foundations.
        </p>

      </section>

      {/* JAVA ROADMAP TIMELINE */}
      <section className="py-24 bg-gradient-to-b from-orange-50 to-white" id="roadmap">
        <h2 className="text-4xl font-extrabold text-center mb-16 text-gray-900">
          Java + DSA Roadmap to Crack <span className="text-orange-500">Coding Interviews</span>
        </h2>
        ...
        <div className="max-w-5xl mx-auto relative">
          ...
          <div className="space-y-10">
            {[
              "Java Fundamentals — Syntax, Variables, Data Types",
              "Control Flow — Loops, Methods & Exception Handling",
              "Object Oriented Programming — Classes, Objects, Inheritance, Polymorphism",
              "Collections Framework — List, Set, Map & Iterators",
              "Data Structures — Stack, Queue, Linked List, Tree, Graph",
              "Algorithms — Sorting, Searching, Recursion & Dynamic Programming",
              "Core Java Projects, GitHub Portfolio & Interview Preparation",
            ].map((step, index) => (
              <div
                key={index}
        ...
        <p className="text-center mt-16 text-lg text-gray-700 max-w-3xl mx-auto">
          Follow this structured java roadmap & become interview-ready for roles in top product & service companies.
        </p>
      </section >
      {/* JAVA STUDENT REVIEWS */}
      <section className="py-24 bg-gradient-to-b from-white to-orange-50">
        <h2 className="text-4xl font-extrabold text-center mb-16 text-gray-900">
          ...
          {[
            {
              ...
              review:
                "I learned Core Java and DSA from scratch. The structured roadmap and practice problems helped me crack my campus placement interview.",
            },
            {
              name: "Pooja",
              img: "https://randomuser.me/api/portraits/women/36.jpg",
              review:
                "Collections, multithreading and backend concepts were explained very clearly. The mock interviews gave me real confidence for Java roles.",
            ...
            },
            {
              ...
              review:
                "From core Java to Spring boot basics and DSA, everything was well covered. This course gave me confidence to apply for Java developer roles.",
            },
          ].map((item, i) => (
            <div
              key={i}
        ...
        <p className="text-center mt-14 text-lg text-gray-700">
          🎓 1000+ students have successfully started their Java careers with{" "}
      ...
      <section className="py-24 bg-gradient-to-b from-white to-orange-50">
          ...
          >
            ...
            <div>
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                Every learner receives a professional Java course completion
                certificate from{" "}
          ...
          >
            ...
            <div>
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                ...
                for {""} <span className="font-semibold text-orange-600">Java developer roles, backend positions & IT companies</span>.
              </p>
            </div>
          </div>
        </div>
        ...
        <p className="text-center mt-14 text-xl font-medium text-gray-800">
          Your hard work + our guidance = a strong beginning to your Java career 🚀
        </p>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-24" id="syllabus">
        ...
        ${openIndex === index
          ...
          ${openIndex === index ? "grid-rows-[1fr] py-2" : "grid-rows-[0fr]"}`}
              >
